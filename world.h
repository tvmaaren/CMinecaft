...
#define WORLD_BLOCK_INDEX(w,i)  ((BlockType*)(worldl(w)[i/MAX_CHUNK_BlOCKS].blocks.l))[i%MAX_CHUNK_BlOCKS]
...
#define POS_TO_INDEX(world,pos,chunk) (getChunk(world,pos,chunk)*MAX_CHUNK_BlOCKS+POS_TO_BLOCK_INDEX(pos))
